...
(() => {
  ...
  function o() {
          ...
          (function (r, e, o) {
            var a,
              ...
              l = {
                ...
                f: d.bind(n, 4),
                d: function (t, r) {
                  return (a = t), (i = 0), (c = n), (l.n = r), u;
                },
              };
            function d(r, e) {
              for (i = r, c = e, t = 0; !p && s && !o && t < f.length; t++) {
                var o,
                  a = f[t],
                  d = l.p,
                  h = a[2];
                r > 3
                  ? (o = h === e) &&
                    ((c = a[(i = a[4]) ? 5 : ((i = 3), 3)]), (a[4] = a[5] = n))
                  : a[0] <= d &&
                    ((o = r < 2 && d < a[1])
                      ? ((i = 0), (l.v = e), (l.n = a[1]))
                      : d < h &&
                        (o = r < 3 || a[0] > e || e > h) &&
                        ((a[4] = r), (a[5] = e), (l.n = h), (i = 0)));
              }
              if (o || r > 1) return u;
              throw ((p = !0), e);
            }
                    ...
                    if ((i || (o = "next"), (t = a[o]))) {
                      ...
                      1 === i && (t = a.return) && t.call(a),
                        i < 2 &&
                          ...
                          (i = 1));
                    a = n;
                  } else if ((t = (p = l.n < 0) ? c : r.call(e, l)) !== u)
                    break;
                } catch (t) {
                  (a = n), (i = 1), (c = t);
                } finally {
    ...
    var l = [][e]
        ...
        : (a((t = {}), e, function () {
          ...
          t),
      d = (p.prototype = s.prototype = Object.create(l));
    function h(n) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(n, p)
          : ((n.__proto__ = p), a(n, i, "GeneratorFunction")),
  ...
  function i(n, t, r, e, o, a, i) {
    ...
    c.done ? t(u) : Promise.resolve(u).then(e, o);
  }
  var c = "https://rickandmortyapi.com/api/character/";
  const u = (function () {
    var n,
      t =
        ((n = o().m(function n(t) {
            ...
            function (n) {
              for (;;)
                switch ((n.p = n.n)) {
                  case 0:
                    return (
                      (r = t ? "".concat(c).concat(t) : c),
                      (n.p = 1),
                      (n.n = 2),
                      fetch(r)
                    );
                  case 2:
                    return (e = n.v), (n.n = 3), e.json();
                  case 3:
                    return (a = n.v), n.a(2, a);
                  case 4:
                    (n.p = 4), (i = n.v), console.log("Fetch Error", i);
                  case 5:
                    return n.a(2);
                }
            },
  ...
  function s() {
    ...
    function a(r, e, o, a) {
      var u = e && e.prototype instanceof c ? e : c,
          ...
          (function (r, e, o) {
            var a,
              ...
              l = {
                ...
                f: d.bind(n, 4),
                d: function (t, r) {
                  return (a = t), (c = 0), (u = n), (l.n = r), i;
                },
              };
            function d(r, e) {
              for (c = r, u = e, t = 0; !p && s && !o && t < f.length; t++) {
                var o,
                  a = f[t],
                  d = l.p,
                  h = a[2];
                r > 3
                  ? (o = h === e) &&
                    ((u = a[(c = a[4]) ? 5 : ((c = 3), 3)]), (a[4] = a[5] = n))
                  : a[0] <= d &&
                    ((o = r < 2 && d < a[1])
                      ? ((c = 0), (l.v = e), (l.n = a[1]))
                      : d < h &&
                        (o = r < 3 || a[0] > e || e > h) &&
                        ((a[4] = r), (a[5] = e), (l.n = h), (c = 0)));
              }
              if (o || r > 1) return i;
              throw ((p = !0), e);
            }
                    ...
                    if ((c || (o = "next"), (t = a[o]))) {
                      ...
                      1 === c && (t = a.return) && t.call(a),
                        c < 2 &&
                          ...
                          (c = 1));
                    a = n;
                  } else if ((t = (p = l.n < 0) ? u : r.call(e, l)) !== i)
                    break;
                } catch (t) {
                  (a = n), (c = 1), (u = t);
                } finally {
    ...
    var l = [][e]
        ...
        : (f((t = {}), e, function () {
          ...
          t),
      d = (p.prototype = c.prototype = Object.create(l));
    function h(n) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(n, p)
          : ((n.__proto__ = p), f(n, o, "GeneratorFunction")),
        (n.prototype = Object.create(d)),
        n
      );
    }
    ...
    function h(n) {
      return (
        Object.setPrototypeOf
          ...
          : ((n.__proto__ = s), d(n, o, "GeneratorFunction")),
  ...
  function y() {
    ...
    function l(n) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(n, s)
          : ((n.__proto__ = s), m(n, o, "GeneratorFunction")),
        (n.prototype = Object.create(p)),
        n
      );
    }
          ...
          ((n = l().m(function n() {
            ...
            return l().w(function (n) {
              for (;;)
                switch (n.n) {
                  case 0:
                    return (t = location.hash.slice(2)), (n.n = 1), u(t);
                  case 1:
                    if ((r = n.v)) {
                      n.n = 2;
                      break;
                    ...
                    return n.a(
                      2,
                      '<div class="Error">Character not found</div>'
                    );
                  case 2:
                    return (
                      (e =
                        '\n    <div class="Characters-inner">\n        <article class="Characters-card">\n            <img src="'
                          ...
                          .concat(
                            r.origin ? r.origin.name : "Unknown",
                            "</span></h3>\n            <h3>Location: <span>"
                          )
                          .concat(
                            r.location ? r.location.name : "Unknown",
                            "</span></h3>\n        </article>\n    </div>\n    "
                          )),
                      n.a(2, e)
                    );
            ...
            for (;;)
              switch (n.n) {
                ...
                case 1:
                  return (
                    (t.innerHTML = n.v),
                    (o = location.hash.slice(1).toLowerCase() || "/"),
                    (a =
                      "/" === o ? b["/"] : o.match(/^\/\d+$/) ? b["/:id"] : v),
                    (n.n = 2),
                    a()
                  );
                case 2:
